...
//    }
    ...
    private void validateUniqueness(String title, String slug) {
        if (repository.existsByTitle(title)) {
            throw new ConflictException(ProductErrors.Target.TITLE, ProductErrors.Code.PRODUCT_TITLE_ALREADY_EXISTS);
        }
        if (repository.existsBySlug(slug)) {
            throw new ConflictException(ProductErrors.Target.SLUG, ProductErrors.Code.PRODUCT_SLUG_ALREADY_EXISTS);
        }
    }
}
