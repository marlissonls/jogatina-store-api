...
public class UserPermission {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getId(), that.getId()) && Objects.equals(getUser(), that.getUser()) && Objects.equals(getPermission(), that.getPermission());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getUser(), getPermission());
    }
