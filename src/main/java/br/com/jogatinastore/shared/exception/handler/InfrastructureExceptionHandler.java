...
import br.com.jogatinastore.shared.exception.errors.SystemErrors;
...
public class InfrastructureExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> handleInfrastructureExceptions(Exception ex) {
